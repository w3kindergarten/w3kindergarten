...
<body>
	...
	<div class="navbackground">
		<div class="nav">
			<button class="nav-tutorials" style="visibility: visible;" onclick="window.open('tutorialmenu.jsp','TutorialMenu','width=1515px;,height=400px,right=100000px,top=240px')">
